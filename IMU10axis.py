...
'''    
    ...
    bmp_388 = bmp_alt.BMP388()  
    

    #for i in sample_length:
    #while True:
    temperature,pressure,altitude = bmp_388.get_temperature_and_pressure_and_altitude()
    ...
    '''
        ...
        print(outputString)
    '''
    return [kalmanX,kalmanY,tiltCompensatedHeading,pressure,temperature,altitude]    
